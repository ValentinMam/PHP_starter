...
?>
    ...
    <section>
        ...
        <p><a href="index.php">Lien vers l'application</a></p>
        <h3>Repo du projet</h3>
        <p><a
                href="https://github.com/OpenClassrooms-Student-Center/Concevez-votre-site-web-avec-PHP-MySQL/tree/main/P2/P2C6">Lien
            </a>
        </p>
    </section>
    <section>
